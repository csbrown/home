" Dark Tango colorscheme for Vim
"
...
let g:colors_name = "kiwi_tango"
 
highlight Normal gui=none guifg=#cafcff guibg=#0d0d0d
highlight CursorLine gui=none guibg=#1d1d1d
highlight CursorColumn gui=none guibg=#1d1d1d
...
highlight LineNr gui=none guifg=#888a85
"highlight LineNr gui=none guifg=#888a85 guibg=#eeeeec
highlight NonText gui=none guifg=#555753
...
highlight Comment gui=none guifg=#3465a4 guibg=bg
